...
from pywhatkit import search, playonyt  # Import search and YouTube playback.
from dotenv import dotenv_values  # Import for loading environment variables.
from bs4 import BeautifulSoup  # Import BeautifulSoup for parsing HTML content.
from rich import print  # Import rich for styled text printing.
from groq import Groq
import webbrowser  # Import webbrowser for web-related tasks.
import subprocess
import requests  # Import requests for handling web requests.
import keyboard  # Import keyboard for keyboard-related tasks.
